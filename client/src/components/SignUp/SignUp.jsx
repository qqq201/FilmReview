                            ...
                            {visible ? (
                                ...
                                <>
                                    ...
                                    <form className="form-input d-flex flex-column target align-items-start" onSubmit={handleSubmitLast}>
                                        <label htmlFor="password" id="password" className="label-password">Mật
                                            khẩu</label>
                                        <input type="password" className="password-input mb-4" id="password"
                                               placeholder="Mật khẩu"
                                               name="password"/>

                                        <label htmlFor="password-verify"><span id="password_verify"
                                                                               className="label-password">Nhập lại mật khẩu</span></label>
