                        ...
                        return (
                            ...
                            <div className="card col bg-white m-2">
                                <div id="content-image">
                                    <img className="image-border mt-5 text-float mr-3" src={e.user.avatar} alt="avatar"/>
                                    <div className="mt-5 mb-2 ml-5 text-black" id="">{e.user.name}</div>
                                    <date className="ml-5 text-black">{e.user.date}</date>
                                ...
                                <div className="row my-3">
                                    <div className="col-2">
                                        <button className="btn btn-outline-success"><i className="fa fa-thumbs-o-up"
                                                                                       aria-hidden="true"/> <span
                                            className="m-2">20</span></button>
                                    </div>
                                    <div className="col-2">
                                        <button className="btn btn-outline-danger"><i className="fa fa-thumbs-o-down"
                                                                                      aria-hidden="true"/> <span
                                            className="m-2">20</span></button>
                                    </div>
